...
export function ProgramCard({ data, index }: ProgramCardProps) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px', alignItems: 'flex-start' }}>
        {/* Left Info: Header and Unit */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
            <div>
              ...
              <h3 style={{ fontWeight: 'bold', color: 'var(--text-primary)', fontSize: '18px', lineHeight: 1.3, margin: 0 }}>
                {data['Nama RO']}
              </h3>
            </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
            ...
            <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.4, margin: 0 }}>
              {data.Unit}
            </p>
          </div>
        </div>

        {/* Right Info: Progress Bars */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {/* Anggaran Section */}
