-- ============================================================================
-- PATCH: pencatatan_non_tender_realisasi — tambah kolom kode_penyedia
-- ----------------------------------------------------------------------------
-- File sumber pencatatan-non-tender-realisasi_2026.json (endpoint
-- /v1/tender/pencatatan-non-tender-realisasi) mengirim field `kode_penyedia`
-- yang belum punya kolom di tabel. Tanpa kolom ini PostgREST menolak seluruh
...
ALTER TABLE public.pencatatan_non_tender_realisasi
  ADD COLUMN IF NOT EXISTS kode_penyedia TEXT;
