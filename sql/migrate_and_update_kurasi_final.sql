-- =======================================================================
-- SCRIPT MASTER: MIGRASI TABEL KURASI & PEMBARUAN VIEW (ANTI ERROR)
-- =======================================================================
...
-- 2. MIGRASI DATA PENYEDIA (Abaikan jika duplikat)
...
-- 3. MIGRASI DATA SWAKELOLA (Abaikan jika duplikat)
INSERT INTO ai_kurasi_paket (kd_rup, status_kurasi, catatan_kurasi, rekomendasi_kurasi)
SELECT 
    kd_rup::bigint, 
    status_kurasi, 
...
-- 4. DROP VIEW YANG BERGANTUNG PADA KOLOM LAMA SECARA CASCADE
DROP VIEW IF EXISTS view_paket_penyedia_master_data CASCADE;
DROP VIEW IF EXISTS view_paket_swakelola_master_data CASCADE;

-- 5. HAPUS KOLOM LAMA DARI TABEL ASLI (Aman karena view-nya sudah didrop di langkah 4)
...
-- 6. RECREATE VIEW MASTER DATA DENGAN JOIN KE TABEL BARU
...
-- 9. RECREATE PENUNJUKAN LANGSUNG
...
-- 10. RECREATE PENGADAAN LANGSUNG
